                ...
                <td className='py-2 px-4 border-b border-gray-200 relative'>
                  <div className='relative inline-block text-left group'>
                    ...
                    <div className='z-10 hidden absolute right-0 md:left-0 top-0 mt-2 w-32 bg-white border border-gray-200 rounded shadow group-hover:block'>
                      <button className='block w-full text-left px-4 py-2 text-blue-700 hover:bg-blue-50'>Accept</button>
                      <button className='block w-full text-left px-4 py-2 text-red-700 hover:bg-red-50'>Reject</button>
                    </div>
                  </div>
                </td>
              </tr>
