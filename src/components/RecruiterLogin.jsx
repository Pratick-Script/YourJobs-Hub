    ...
    return (
        <div className='absolute top-0 bottom-0 right-0 left-0 z-10 backdrop-blur-sm bg-black/30 flex justify-center items-center'>
            <form onSubmit={onSubmitHandler} action="" className='relative bg-white p-10 rounded-xl text-slate-500'>
                ...
                <p className='text-sm'>Welcome back! Please sign in to continue</p>
                {
                    state === "Sign Up" && isTextDataSubmitted
                        ...
                        : <>
                            ...
                            <div className='border border-gray-200 px-4 py-2 flex items-center gap-2 rounded-full mt-5 outline-0'>
                ...
                <button type='submit' className='bg-purple-600 text-white py-2 rounded-full w-full cursor-pointer mt-3'>
                ...
                <img src={assets.cross_icon} alt="" className='absolute right-5 top-5 cursor-pointer' onClick={() => { setShowRecruiterLogin(false) }} />
            </form>
        </div>
    )
}
